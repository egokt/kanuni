...
import { ListBuilderImpl } from "./list-builder-impl.js";
import { compile } from "./string-template-helpers.js";
import { TableBuilderImpl } from "./table-builder-impl.js";

export type ContentBuilderImplParagraphDatum<
  ...
  implements ContentBuilder<Params>
{
  ...
  >(
    builder: Builder,
    pushToBuilderData: (
      builderData: ContentBuilderImplListDatum<Params>,
    ) => void,
  ...
  >(
    builder: Builder,
    pushToBuilderData: (
      builderData: ContentBuilderImplTableDatum<Params>,
    ) => void,
  ...
  >(
    builder: Builder,
    pushToBuilderData: (
      builderData: ContentBuilderImplParagraphDatum<Params>,
    ) => void,
    stringsOrBuilderFunction: TemplateStringsArray | ((data: Params) => string),
    ...keys: (keyof Params)[]
  ): Builder {
