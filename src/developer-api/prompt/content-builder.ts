...
export type ContentBuilderFunction<BuilderData extends Record<string, any>> = (
...
export interface ContentBuilder<Params extends Record<string, any> = {}> {
  ...
  list(builderFunction: ListBuilderFunction<Params>): ContentBuilder<Params>;
  table(builderFunction: TableBuilderFunction<Params>): ContentBuilder<Params>;
}
